...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl">
      ...
      <form onSubmit={onSubmitHandler} className="border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rouded-lg shadow-lg">
        ...
        {currState === "Sign up" && !isDataSubmitted && (
          <input
            ...
            value={fullName}
            type="text"
            className="p-2 border border-gray-500 rotate-md focus:outline:none"
